...
class AnsysVerticalFlapFsiSmokeTests(unittest.TestCase):
    ...
    def test_core_uses_the_case_spec_authoritative_reference_subset(self):
        with patch.object(
            vertical_flap_case,
            "run_hibm_mpm_fsi",
            return_value={"computed_result_sources": {"value": "computed"}},
        ) as run:
        ...
        self.assertEqual(
            ...
            dict(vertical_flap_case.CASE_SPEC.reference_results),
        )
    ...
    def test_boundary_predictor_velocity_inlet_does_not_add_projection_source(self):
        ...
        with (
            ...
            patch.object(
                ...
                "_apply_hibm_sharp_marker_boundary_to_fluid",
                return_value=(
                    solid_mpm_fsi_runner._empty_hibm_sharp_marker_boundary_report()
                ),
            ),
            patch.object(
                solid_mpm_fsi_runner,
