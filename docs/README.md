...
1. [`refactoring/ADAPTIVE_SOLID_SUBSTEPS_PERFORMANCE_KALMAN_THREAD_HANDOFF_2026-08-24.md`](refactoring/ADAPTIVE_SOLID_SUBSTEPS_PERFORMANCE_KALMAN_THREAD_HANDOFF_2026-08-24.md)
   ...
   - [`validation/ANSYS_VERTICAL_FLAP_GRU_KALMAN_LIVE_PROBE_GOAL_2026-09-02.md`](validation/ANSYS_VERTICAL_FLAP_GRU_KALMAN_LIVE_PROBE_GOAL_2026-09-02.md)：R25B 容量匹配 G0-M/GDelta-M、冻结 GK1/POD-AR 与 step-7/8 strict-CUDA no-commit matrix；schema-2 OOD、rejected-trial、pressure-matvec、anchor conservation、首猜逐字校验及回滚合同均已锁定。
   - [`validation/ANSYS_VERTICAL_FLAP_GRU_KALMAN_LIVE_PROBE_REPORT_2026-09-02.md`](validation/ANSYS_VERTICAL_FLAP_GRU_KALMAN_LIVE_PROBE_REPORT_2026-09-02.md)：R25B authoritative r3 的 26-arm 原始 work 复算；所有因果 arm 为 6 trials/4 rejected/1440 CG/1452 matvec，仅非因果 Q 为 2/0/480/484，最终 `FAIL_NO_LIVE_SOLVER_WORK_REDUCTION` 并停止 accepted-state predictor 扩展。
...
- [`validation/TUREK_HRON_R15_FALLBACK_VALIDATION_REPORT_2026-09-06.md`](validation/TUREK_HRON_R15_FALLBACK_VALIDATION_REPORT_2026-09-06.md): R15 fallback test corrections, strict-CUDA evidence and pending continuous-validation gates.
