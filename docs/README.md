...
1. [`refactoring/ANSYS_VERTICAL_FLAP_COMPONENT_FACE_PRE_ADMISSION_THREAD_HANDOFF_2026-08-16.md`](refactoring/ANSYS_VERTICAL_FLAP_COMPONENT_FACE_PRE_ADMISSION_THREAD_HANDOFF_2026-08-16.md)
2. [`refactoring/ANSYS_VERTICAL_FLAP_50_STEP_CLOSURE_PERFORMANCE_THREAD_HANDOFF_2026-08-14.md`](refactoring/ANSYS_VERTICAL_FLAP_50_STEP_CLOSURE_PERFORMANCE_THREAD_HANDOFF_2026-08-14.md)
3. [`refactoring/ANSYS_VERTICAL_FLAP_GENERIC_SOLVER_THREAD_HANDOFF_2026-07-23.md`](refactoring/ANSYS_VERTICAL_FLAP_GENERIC_SOLVER_THREAD_HANDOFF_2026-07-23.md)
4. [`VALIDATION.md`](VALIDATION.md) 中对应的运行与证据说明
5. [`../validation_runs/README.md`](../validation_runs/README.md) 中的验证产物索引
