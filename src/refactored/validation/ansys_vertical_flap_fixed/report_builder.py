...
def build_validation_report(
    ...
    *,
    ...
    lines = [
        ...
        f"- This is a Fluent-style visualization of {source_label}, not a Fluent parity validation.",
        "",
        "## Field Summary",
        "",
        "| metric | value |",
    ...
    lines.extend(
        [
            ...
            f"| overall_status | {quality['overall_status']} | candidate_not_parity still means no Fluent parity claim without official numeric exports |",
            "",
            "## Interpretation",
            "",
            f"{source_label} produces a jet-like fixed-flap field, but the report keeps visual similarity separate from numerical convergence and official Fluent parity.",
